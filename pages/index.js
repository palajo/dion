...
import Pressure from '../images/icons/barometer.svg';
import Temperature from '../images/icons/weather-alert.svg';
import Wind from '../images/icons/wind.svg';
import Phone from '../images/icons/phone.svg';

import Slide1 from '../images/slider/homepage-slider/slide-1.jpg';
              ...
              <div className="col-8">
                <div className="row g-4">
                  <div className="col-6">
                    <div className="benefit-block">
                      <div className="block-icon">
                        <Image src={Fire} layout="fixed" width="48" height="48" alt="Fire Icon" />
                      </div>
                      <div className="block-content">
                        <div className="block-title">
                  ...
                  <div className="col-6">
                    <div className="benefit-block">
                      <div className="block-icon">
                        <Image src={Pressure} layout="fixed" width="48" height="48" alt="Pressure Icon" />
                      </div>
                      <div className="block-content">
                        <div className="block-title">
                  ...
                  <div className="col-6">
                    <div className="benefit-block">
                      <div className="block-icon">
                        <Image src={Temperature} layout="fixed" width="48" height="48" alt="Temperature Icon" />
                      </div>
                      <div className="block-content">
                        <div className="block-title">
                  ...
                  <div className="col-6">
                    <div className="benefit-block">
                      <div className="block-icon">
                        <Image src={Wind} layout="fixed" width="48" height="48" alt="Wind Icon" />
                      </div>
                      <div className="block-content">
                        <div className="block-title">
        ...
        <section className="product-slider">
          ...
          <div className="container-fluid p-0">
            <div className="col-12">
              ...
              >
                <SwiperSlide>
                  <Image src={Slide1} alt="Slider Slide 1"/>
                </SwiperSlide>
                <SwiperSlide>
                  <Image src={Slide1} alt="Slider Slide 2"/>
                </SwiperSlide>
                <SwiperSlide>
                  <Image src={Slide1} alt="Slider Slide 3"/>
                </SwiperSlide>
              </Swiper>
            </div>
          </div>
                ...
                <div className="row justify-content-center">
                  <div className="col-auto">
                    <div className="statistic-block">
                      <div className="block-icon">
                        <Image src={Temperature} alt="Temperature Icon" />
                      </div>
                      <div className="block-content">
