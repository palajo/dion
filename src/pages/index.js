                  ...
                  <Col lg={12}>
                    <div className="block block-security">
                      ...
                      <div className="block-content">
                        ...
                        <p>
                          В наявності Димохідні та Парапетні (турбовані) газові водонагрівчі. Ми з радістю вас проконсуьлтуємо та оберемо водонагрівач саме для вашої оселі.
                        </p>
                      </div>
                    </div>
                  </Col>
                  ...
                  <Col lg={12}>
                    <div className="block block-security">
                      ...
                      <div className="block-content">
                        ...
                        <p>
                          Ми відповідально ставмося до людей, що нам довіряють. Тому надаємо всі гарантії та в разі чого – якісне сервісне обслуговування, або ж заміну.
                        </p>
                      </div>
                    </div>
                  </Col>
